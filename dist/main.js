...
const domManager = (function(){
    ...
    const addTaskToProject = (pos, e) => {
        _formModule__WEBPACK_IMPORTED_MODULE_0__["default"].askTaskInfo().then((taskData)=>{
            if(taskData){
                let newTaskData = JSON.parse(taskData);
                selectedProject.addTask((0,_taskFactory__WEBPACK_IMPORTED_MODULE_3__["default"])(newTaskData.title, newTaskData.description, newTaskData.date, newTaskData.priority, false, selectedProject), pos);
                scrollPosition = taskList.scrollTop;
                render(display, projects);  
            }else{
